import { getProductImage, getShopLogo, getAvatarImage, CORE_PRODUCT_IMAGES } from './productImages'

/** Mock 数据版本：升级后自动清空 localStorage 并重新生成 */
export const MOCK_DATA_VERSION = '3.8.2'
...
export const CORE_SHOPS = [
  {
    shopId: 1,
    shopName: '云间丝语',
    shopLogo: getShopLogo(1, [101, 102, 103]),
    rating: 4.9,
    fansCount: 28600,
  ...
  },
  {
    shopId: 2,
    shopName: '墨染匠心馆',
    shopLogo: getShopLogo(2, [301, 302]),
    rating: 4.8,
    fansCount: 15200,
  ...
  },
  {
    shopId: 3,
    shopName: '织梦坊',
    shopLogo: getShopLogo(3, [401, 402]),
    rating: 4.9,
    fansCount: 42100,
  ...
  },
  {
    shopId: 4,
    shopName: '青藤数码',
    shopLogo: getShopLogo(4, [201, 202, 203]),
    rating: 4.7,
    fansCount: 53800,
...
export function generateShops() {
  ...
  EXTRA_SHOP_NAMES.forEach((item, idx) => {
    ...
    shops.push({
      ...
      shopLogo: getShopLogo(shopId, item.categoryIds),
  ...
  shops.forEach((shop) => {
    ...
    for (let i = 0; i < need; i += 1) {
      ...
      const item = {
        ...
        stock,
        categoryId,
        image: getProductImage({ id: nextId, categoryId, title }),
        status,
  ...
  const users = [
    {
      ...
      role: 'admin',
      nickname: '系统管理员',
      avatar: getAvatarImage('admin'),
      permissions: ['product', 'category', 'shop', 'order', 'user'],
    ...
    },
    {
      ...
      role: 'admin',
      nickname: '订单运营',
      avatar: getAvatarImage('operator'),
      permissions: ['order'],
